...
/* ── Shared exports reused elsewhere on the FBS review page ─────────────── */
    ...
    <div className="border-b border-white/6 bg-[#0d1117]">
      ...
      <div className="max-w-4xl mx-auto px-[5vw] py-8">
        ...
        <p className="mt-6 max-w-2xl text-sm leading-relaxed text-zinc-400">
          FBS Kenya offers the lowest entry point of any broker on our list.
          Start trading with just $1 via M-Pesa on the Cent account. One of the
          most popular forex brokers across Kenya and East Africa, FBS is best
          suited to beginners who want real market exposure with minimal risk.
        </p>
