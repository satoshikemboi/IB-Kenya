...
const JustMarkets      = lazy(() => import("./justmarkets/JustMarkets"));
...
import HighLeverageBrokersKenya from "./categories/HighLeverageBrokersKenya";
          ...
          <main className="flex-1">
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route path="/high-leverage-brokers-kenya" element={<HighLeverageBrokersKenya />} />
